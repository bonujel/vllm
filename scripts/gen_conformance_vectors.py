...
These vectors are the executable form of docs/DETERMINISTIC_SAMPLING_CONTRACT.md.
The vLLM Python pipeline and the gonka Go validator must both reproduce them
bit-for-bit. Run:
